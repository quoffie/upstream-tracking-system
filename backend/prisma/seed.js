...
async function createCompany(name, regNumber, category) {
  return await prisma.company.create({
    data: {
      ...
      category,
      specialization: category === 'SPECIALIZED' ? ['Upstream Oil & Gas Exploration', 'Petroleum Production', 'Offshore Drilling'] : ['Upstream Support Services', 'Petroleum Logistics', 'Oilfield Services'],
...
async function createCompanyRegistrations() {
  const registrations = [
    {
      companyName: 'Ghana Upstream Energy Ltd',
      registrationNumber: 'REG-2024-001',
      businessType: 'Upstream Petroleum Exploration & Production',
      incorporationDate: new Date('2024-01-15'),
      registeredAddress: '123 Independence Avenue, Accra, Ghana',
      contactEmail: 'info@ghanaupstream.com',
    ...
    {
      companyName: 'Volta Basin Petroleum Services',
      registrationNumber: 'REG-2024-002',
      businessType: 'Upstream Drilling & Oilfield Services',
      incorporationDate: new Date('2024-02-20'),
      registeredAddress: '456 Liberation Road, Tema, Ghana',
      contactEmail: 'contact@voltabasin.com',
    ...
    {
      companyName: 'Gold Coast Offshore Operations',
      registrationNumber: 'REG-2024-003',
      businessType: 'Upstream Offshore Petroleum Operations',
      incorporationDate: new Date('2024-03-10'),
      registeredAddress: '789 Jubilee House Road, Accra, Ghana',
      contactEmail: 'operations@goldcoastoffshore.com',
      contactPhone: '+233 30 555 7890',
      authorizedCapital: 8000000.00,
      paidUpCapital: 4000000.00,
      status: 'APPROVED',
    },
  ];
  ...
  const permits = [
    {
      ...
      title: 'Deepwater Tano Cape Three Points Exploration',
      description: 'Exploration permit for Deepwater Tano Cape Three Points Basin covering 2000 sq km offshore Ghana',
    ...
    },
    {
      ...
      title: 'Jubilee Field Production Operations',
      description: 'Production permit for Jubilee oil field operations in Ghana offshore waters',
    ...
    },
    {
      ...
      title: 'TEN Field Development Project',
      description: 'Development permit for TEN (Tweneboa-Enyenra-Ntomme) oil field infrastructure in Ghana',
