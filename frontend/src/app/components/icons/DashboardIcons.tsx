...
export function ApplicationIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      fill="none"
      viewBox="0 0 24 24"
...
export function PermitIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      fill="none"
      viewBox="0 0 24 24"
...
export function PersonnelIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      fill="none"
      viewBox="0 0 24 24"
...
export function PaymentIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      fill="none"
      viewBox="0 0 24 24"
...
export function ComplianceIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      fill="none"
      viewBox="0 0 24 24"
...
export function RefreshCwIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path d="M21 2v6h-6"/>
      <path d="M3 12A9 9 0 0 1 15 3v1"/> 
      <path d="M3 22v-6h6"/>
      <path d="M21 12A9 9 0 0 1 9 21v-1"/>
    </svg>
  );
}
...
export function ReviewIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      fill="none"
      viewBox="0 0 24 24"
