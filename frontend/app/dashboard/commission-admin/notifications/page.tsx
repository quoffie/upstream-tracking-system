    ...
    const mockNotifications: Notification[] = [
      {
        ...
        message: 'Application APP-2024-001 from Chevron Nigeria Limited has been pending approval for 5 days, exceeding the 3-day SLA.',
      ...
      },
      {
        ...
        message: 'Payment transaction TXN-004 for ExxonMobil Nigeria has failed due to insufficient funds. Immediate attention required.',
      ...
      },
      {
        ...
        message: 'Total E&P Nigeria has submitted a new Joint Venture application (APP-2024-003) requiring CEO approval.',
