...
import { CurrencyDollarIcon, BuildingOfficeIcon, ExclamationTriangleIcon, CogIcon } from '@heroicons/react/24/outline';
...
export default function CommissionAdminDashboard() {
  ...
  useEffect(() => {
    ...
    if (!userData) {
      router.push('/login?redirect=/dashboard/commission-admin');
      return;
    }
  ...
  return (
    ...
    >
      <div className="space-y-8">
        ...
        {/* Quick Navigation to Menu Pages */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Link href="/dashboard/commission-admin/financial-overview" className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 hover:shadow-lg transition-all duration-200 border border-green-200">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-semibold text-green-800">Financial Overview</h3>
                <p className="text-sm text-green-600 mt-1">Revenue, fees, and payments</p>
              </div>
              <CurrencyDollarIcon className="h-8 w-8 text-green-600" />
            </div>
          </Link>
          
          <Link href="/dashboard/commission-admin/companies" className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 hover:shadow-lg transition-all duration-200 border border-blue-200">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-semibold text-blue-800">Top Companies</h3>
                <p className="text-sm text-blue-600 mt-1">Performance rankings</p>
              </div>
              <BuildingOfficeIcon className="h-8 w-8 text-blue-600" />
            </div>
          </Link>
          
          <Link href="/dashboard/commission-admin/critical-issues" className="bg-gradient-to-br from-red-50 to-red-100 rounded-xl p-6 hover:shadow-lg transition-all duration-200 border border-red-200">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-semibold text-red-800">Critical Issues</h3>
                <p className="text-sm text-red-600 mt-1">Urgent matters</p>
              </div>
              <ExclamationTriangleIcon className="h-8 w-8 text-red-600" />
            </div>
          </Link>
          
          <Link href="/dashboard/commission-admin/executive-tools" className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-6 hover:shadow-lg transition-all duration-200 border border-purple-200">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-semibold text-purple-800">Executive Tools</h3>
                <p className="text-sm text-purple-600 mt-1">Quick actions</p>
              </div>
