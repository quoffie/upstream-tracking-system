...
export default function RegulatoryDocs() {
  ...
  const documents = [
    ...
    },
    {
      ...
      size: '3.2 MB',
      date: '2020-03-10',
      description: 'Comprehensive environmental protection guidelines for petroleum activities.'
    },
    {
      id: 4,
      title: 'Health and Safety Standards for Offshore Operations',
      category: 'standards',
      type: 'PDF',
      size: '2.1 MB',
      date: '2019-07-22',
      description: 'Safety standards and protocols for offshore petroleum operations.'
    },
    {
      id: 5,
      ...
      size: '1.5 MB',
      date: '2011-04-01',
      description: 'Act governing the management of petroleum revenues in Ghana.'
    },
    {
      id: 6,
      title: 'Upstream Petroleum Data Management Guidelines',
      category: 'guidelines',
      type: 'PDF',
      size: '2.8 MB',
      date: '2021-09-15',
      description: 'Guidelines for data collection, storage, and reporting in upstream operations.'
    },
    {
      id: 7,
    ...
    {
      id: 8,
      title: 'Annual Reporting Requirements for Petroleum Companies',
      category: 'guidelines',
      type: 'PDF',
      size: '1.2 MB',
      date: '2023-02-28',
      description: 'Requirements and formats for annual reporting by petroleum companies.'
    }
  ];
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-r from-blue-800 to-blue-600 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Regulatory Documents</h1>
          <p className="text-xl md:text-2xl max-w-3xl mx-auto">
            Access laws, regulations, and guidelines governing Ghana's petroleum sector
          </p>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid gap-6">
              {filteredDocuments.map(doc => (
                <div key={doc.id} className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-lg transition duration-300">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                    ...
                    <div className="mt-4 md:mt-0 md:ml-6">
                      <button
                        ...
                        className="bg-blue-800 hover:bg-blue-900 text-white px-6 py-2 rounded-md transition duration-300 flex items-center"
                      >
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-blue-800 mb-6">Need Additional Resources?</h2>
            <p className="text-lg text-gray-700 mb-8">
              Can't find what you're looking for? Contact our regulatory affairs team for assistance.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                href="/contact" 
                className="bg-blue-800 hover:bg-blue-900 text-white px-6 py-3 rounded-md transition duration-300"
              >
                Contact Regulatory Affairs
              </Link>
              <Link 
                href="/faq" 
                className="bg-gray-600 hover:bg-gray-700 text-white px-6 py-3 rounded-md transition duration-300"
              >
                View FAQ
              </Link>
            </div>
