...
// Google Maps component to prevent hydration issues
function GoogleMapComponent() {
  return (
    <iframe 
      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3970.6602389803274!2d-0.1955774250144231!3d5.617085194363929!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xfdf9ba44a30719b%3A0xea3f4351cd65a9e5!2sPetroleum%20Commission%2C%20Ghana!5e0!3m2!1sen!2sus!4v1748635516081!5m2!1sen!2sus" 
      width="100%" 
      height="300" 
      style={{border: 0}} 
      allowFullScreen 
      ...
      title="Petroleum Commission Ghana Location"
    />
  );
}

// Dynamic import to prevent SSR hydration issues
const GoogleMap = dynamic(() => Promise.resolve(GoogleMapComponent), { ssr: false });
      ...
      <section className="bg-gradient-to-r from-blue-800 to-blue-600 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl max-w-3xl mx-auto">
            Get in touch with the Petroleum Commission of Ghana
          </p>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="regulatory">Regulatory Question</option>
              ...
              <div>
                ...
                <div className="bg-gray-50 p-6 rounded-lg mb-6">
                  ...
                  <p className="text-gray-700">
                    Petroleum Commission<br />
                    No. 8 Switchback Road<br />
                ...
                <div className="bg-gray-50 p-6 rounded-lg mb-6">
                  ...
                  <div className="space-y-2 text-gray-700">
                    <p><strong>Main Line:</strong> +233 (0) 302 540 380</p>
                    <p><strong>Technical Support:</strong> +233 (0) 302 540 381</p>
                    <p><strong>Emergency Line:</strong> +233 (0) 302 540 382</p>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 p-6 rounded-lg mb-6">
                  ...
                  <div className="space-y-2 text-gray-700">
                    <p><strong>General Inquiries:</strong> info@petrocom.gov.gh</p>
                    <p><strong>Technical Support:</strong> support@petrocom.gov.gh</p>
                    <p><strong>Regulatory Affairs:</strong> regulatory@petrocom.gov.gh</p>
                    <p><strong>Media Inquiries:</strong> media@petrocom.gov.gh</p>
                  </div>
                </div>
            ...
            {/* Map Section */}
            <div className="mt-16">
              <h2 className="text-3xl font-bold text-blue-800 mb-6 text-center">Find Us</h2>
